...
@interface LPSRSecurityPolicy : NSObject

/**
 A default `LPSRSecurityPolicy` implementation specifies socket security and
 validates the certificate chain.

 Use a subclass of `LPSRSecurityPolicy` for more fine grained customization.
 */
...
/**
 ...
 you're free to override it in a subclass. See `LPSRPinningSecurityPolicy.h` for
 an example.
