...
@property (nonatomic, readonly, copy) NSString * _Nullable timestampRepresentation;
...
@interface NSKeyedUnarchiver (SWIFT_EXTENSION(LPMessagingSDK))
- (Class _Nullable)classForClassName:(NSString * _Nonnull)codedName SWIFT_WARN_UNUSED_RESULT SWIFT_DEPRECATED_OBJC("Swift method 'NSKeyedUnarchiver.class(forClassName:)' uses '@objc' inference deprecated in Swift 4; add '@objc' to provide an Objective-C entrypoint");
@end
...
SWIFT_CLASS("_TtC14LPMessagingSDK30StructuredContentItemContainer")
