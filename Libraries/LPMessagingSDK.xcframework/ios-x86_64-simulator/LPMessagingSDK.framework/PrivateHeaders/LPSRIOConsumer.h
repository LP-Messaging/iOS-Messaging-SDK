...
@class LPSRWebSocket; // TODO: (nlutsenko) Remove dependency on LPSRWebSocket here.

// Returns number of bytes consumed. Returning 0 means you didn't match.
// Sends bytes to callback handler;
typedef size_t (^stream_scanner)(NSData *collected_data);
typedef void (^data_callback)(LPSRWebSocket *webSocket,  NSData *data);

@interface LPSRIOConsumer : NSObject {
