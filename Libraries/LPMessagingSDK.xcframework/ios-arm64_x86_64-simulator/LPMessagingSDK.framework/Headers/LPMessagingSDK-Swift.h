...
/// Setting this to <code>false</code> will defer the network request until the configuration is explicitly requested.
///
- (BOOL)initialize:(NSString * _Nullable)brandID monitoringInitParams:(LPMonitoringInitParams * _Nullable)monitoringInitParams preloadConfiguration:(BOOL)preloadConfiguration error:(NSError * _Nullable * _Nullable)error;
...
/// Defaults to <code>true</code>. Setting this to <code>false</code> defers network requests until the configuration
...
///
- (void)initialize:(NSString * _Nullable)brandID monitoringInitParams:(LPMonitoringInitParams * _Nullable)monitoringInitParams preloadConfiguration:(BOOL)preloadConfiguration completion:(void (^ _Nonnull)(void))completion failure:(void (^ _Nonnull)(NSError * _Nonnull))failure;
/// Initialize the SDK and all of its components.
/// It’s recommended to call this method early in the application’s lifecycle, for example,
/// in your <code>AppDelegate</code>’s <code>application(_:didFinishLaunchingWithOptions:)</code> method.
/// \param brandID The account ID for the LivePerson brand.
