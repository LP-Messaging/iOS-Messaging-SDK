...
- (void)initialize:(NSString * __nonnull)accountId;
- (BOOL)resolveConversation;
- (BOOL)markAsUrgentWithUrgent:(BOOL)urgent;
- (BOOL)isUrgent;
- (BOOL)isSdkReady;
- (void)setUserProfile:(LPUser * __nonnull)user;
...
- (void)createConversationWithContainerViewController:(UIViewController * __nullable)containerViewController;
- (void)toggleChatActions;
