...
*/
+ (BOOL)initializeAMS SWIFT_METHOD_FAMILY(none);
/**
...
*/
+ (NSString * _Nullable)agentNameUIRepresentation:(LPConversationEntity * _Nullable)conversation;
/**
...
*/
+ (LPMessageEntity * _Nullable)createMessageMaskedLocalMessage:(LPConversationEntity * _Nonnull)conversation isRealTimeMasking:(BOOL)isRealTimeMasking;
/**
  Creates welcome local system message for conversation
*/
+ (LPMessageEntity * _Nullable)createWelcomeLocalMessage:(LPConversationEntity * _Nonnull)conversation;
/**
...
*/
+ (NSURL * _Nullable)structuredContentUrlFrom:(NSString * _Nonnull)messageContent;
...
*/
+ (NSArray<LPMessageEntity *> * _Nullable)getLoadingStructureContentMessages;
/**
...
*/
+ (NSArray<LPCustomItemEntity *> * _Nullable)getLoadingStructureContentCustomItems;
