...
@property (nonatomic, copy) void (^ _Nullable reachabiltyChangedBlock)(BOOL isReachable);
+ (GlobalTransportManager * _Nonnull)instance;
- (void)httpRequest:(NSString * _Nonnull)httpMethod dataPost:(NSString * _Nonnull)dataPost destination:(NSString * _Nonnull)destination headers:(NSDictionary<NSString *, NSString *> * _Nullable)headers useCache:(BOOL)useCache successHandler:(void (^ _Nonnull)(NSDictionary * _Nullable response))successHandler failHandler:(void (^ _Nonnull)(NSError * _Nullable error))failHandler;
...
- (void)loadImageFromURL:(NSString * _Nullable)imageUrl completion:(void (^ _Nonnull)(UIImage * _Null_unspecified image, BOOL downloaded))completion;
- (void)clearManager;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
+ (void)isVersionApplicable:(NSString * _Nonnull)brandId completion:(void (^ _Nonnull)(BOOL isApplicable))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
- (void)fetchUser:(NSString * _Nonnull)brandID userID:(NSString * _Nonnull)userID isMe:(BOOL)isMe completion:(void (^ _Nullable)(LPUserEntity * _Nonnull user))completion failure:(void (^ _Nullable)(NSError * _Nonnull error))failure;

/// Attach completion block which is being invoken when the Consumer (My) User is retrieved
- (void)attachMyUserCompletion:(void (^ _Nonnull)(LPUserEntity * _Nonnull user))completion;
...
+ (void)getDataFromUrl:(NSURL * _Nonnull)urL completion:(void (^ _Nonnull)(NSData * _Nullable data, NSError * _Nullable error))completion;
