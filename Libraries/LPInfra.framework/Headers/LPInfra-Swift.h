...
- (void)writeString:(NSString * __nonnull)str completion:(void (^ __nullable)(void))completion;
...
///
/// \param completion The (optional) completion handler.
- (void)writeData:(NSData * __nonnull)data completion:(void (^ __nullable)(void))completion;
- (void)writePing:(NSData * __nonnull)data completion:(void (^ __nullable)(void))completion;
