...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) CSDSManager * _Nonnull instance;)
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ConfigurationManager * _Nonnull instance;)
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) DataManager * _Nonnull instance;)
+ (DataManager * _Nonnull)instance;
- (BOOL)initialize SWIFT_METHOD_FAMILY(none);
...
@interface GlobalTransportManager (SWIFT_EXTENSION(LPInfra)) <NSURLSessionDataDelegate>
...
@interface GlobalTransportManager (SWIFT_EXTENSION(LPInfra)) <NSURLSessionDownloadDelegate>
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) ImagesManager * _Nonnull instance;)
...
SWIFT_CLASS("_TtC7LPInfra13LPFileManager")
@interface LPFileManager : NSObject <GeneralManagerProtocol>
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, copy) NSString * _Nonnull filesDirectoryPath;)
+ (NSString * _Nonnull)filesDirectoryPath;
+ (void)setFilesDirectoryPath:(NSString * _Nonnull)value;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) LPFileManager * _Nonnull instance;)
+ (LPFileManager * _Nonnull)instance;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
/**
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) NotificationManager * _Nonnull instance;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) PusherManager * _Nonnull instance;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) SocketTransportManager * _Nonnull instance;)
...
*/
+ (UIImage * _Nullable)blurImageWithImage:(UIImage * _Nonnull)image radius:(CGFloat)radius size:(CGSize)size;
@end
...
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, strong) UserManager * _Nonnull instance;)
...
SWIFT_CLASS_PROPERTY(@property (nonatomic, class, readonly, copy) NSString * _Nonnull ALLOW_SDK_LOG_TO_FILE_KEY;)
+ (NSString * _Nonnull)ALLOW_SDK_LOG_TO_FILE_KEY;
SWIFT_CLASS_PROPERTY(@property (nonatomic, class) BOOL allowLogToFile;)
+ (BOOL)allowLogToFile;
